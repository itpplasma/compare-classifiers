...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
kern_num = exp(-0.5d0*(y_a - y_b)**2/ly**2) + exp(-0.5d0*sin(0.5d0*x_a - &
      0.5d0*x_b)**2/lx**2)
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdy_num = 1.0d0*(-y_a + y_b)*exp(-0.5d0*(y_a - y_b)**2/ly**2)/ly**2
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdy0_num = 1.0d0*(y_a - y_b)*exp(-0.5d0*(y_a - y_b)**2/ly**2)/ly**2
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
d2kdydy0_num = 1.0d0*(ly**2 - (y_a - y_b)**2)*exp(-0.5d0*(y_a - y_b)**2/ &
      ly**2)/ly**4
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdly_num = 1.0d0*(y_a - y_b)**2*exp(-0.5d0*(y_a - y_b)**2/ly**2)/ly**3
end function
...
d3kdydy0dly_num = (-2.0d0*ly**4 + 5.0d0*ly**2*(y_a - y_b)**2 - 1.0d0*( &
      y_a - y_b)**4)*exp(-0.5d0*(y_a - y_b)**2/ly**2)/ly**7
end function
